...
let test_get_line_returns_line_when_we_insert_line_break_at_middle _ =
  ...
  let rope = Piece_rope.create str |> Piece_rope.insert 4 "\n" in
  let str = "abcd\nefghij" in
  let str_lines = String.split_on_char '\n' str in
  let _ =
    assert_equal ~printer:print
      (List.nth str_lines 0 ^ "\n")
      (Piece_rope.get_line 0 rope)
  in
  assert_equal ~printer:print (List.nth str_lines 1)
    (Piece_rope.get_line 1 rope)
  |> ignore
...
let test_get_line_splits_correctly_when_we_insert_into_middle_of_piece _ =
  ...
  let testRope =
    Piece_rope.insert 27 "\n" initRope |> Piece_rope.insert 207 "\n"
  in
...
let test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_complex_string
    _ =
  let initString =
    "Lorem ipsum\n\
     dolor sit amet,\n\
...
let test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_first_half
    _ =
  let initString =
    "Lorem ipsum\n\
     dolor sit amet,\n\
...
let test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_last_half
    _ =
  let initString =
    "Lorem ipsum\n\
     dolor sit amet,\n\
  ...
  let _ =
    assert_equal ~printer:print
      "ipsum. Cras condimentumsodales tincidunt. Praesent" line11
  in

  let rope = Piece_rope.delete 123 9 rope in
  let line9 = Piece_rope.get_line 8 rope in
  let _ =
    assert_equal ~printer:print "sollicitudin ultrices mi dui et\n" line9
  in
  ...
  in
  assert_equal ~printer:print
    "ipsum. Cras condimentumsodales tincidunt. Praesent" line8

let test_get_line_returns_correct_segments_when_we_delete_multiple_line_breaks_in_middle
    _ =
  let initString =
    "Lorem ipsum\n\
     dolor sit amet,\n\
...
let test_suite =
  "Get_line_tests"
  >::: [
         "test_get_line_returns_inserted_line_after_create "
         >:: test_get_line_returns_inserted_line_after_create;
         "test_get_line_returns_line_when_we_insert_line_break_at_middle"
         >:: test_get_line_returns_line_when_we_insert_line_break_at_middle;
         "test_get_line_splits_correctly_when_we_insert_into_middle_of_piece"
         >:: test_get_line_splits_correctly_when_we_insert_into_middle_of_piece;
         "test_get_line_returns_whole_string_when_we_delete_line_break_in_middle"
         >:: test_get_line_returns_whole_string_when_we_delete_line_break_in_middle;
         "test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_complex_string"
         >:: test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_complex_string;
         "test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_first_half"
         >:: test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_first_half;
         "test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_last_half "
         >:: test_get_line_returns_correct_segments_when_we_delete_line_breaks_in_last_half;
         "test_get_line_returns_correct_segments_when_we_delete_multiple_line_breaks_in_middle "
         >:: test_get_line_returns_correct_segments_when_we_delete_multiple_line_breaks_in_middle;
       ]
