...
let test_substrings_by_tenths rope total_length =
  ...
  let ropeSubLength = String.length ropeSub in
  let expectedLength = String.length expected in
  let _ = assert_equal expectedLength ropeSubLength in
...
let test_suite = 
  "Transaction_tests" >::: [
   ...
   "svelte_whole" >:: test_whole_svelte_substring;
   "rust_whole" >:: test_whole_rust_substring;
   "seph_whole" >:: test_whole_seph_substring;
   "automerge_whole" >:: test_whole_automerge_substring;
