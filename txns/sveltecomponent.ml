...
let data = [|
  ...
  (1173, 0, " -->");
  (1107, 0, "<!-- ");
  (1103, 0, "\t\t\t\t<!-- <input type='number' value={players} on:input={config('players')}> -->\n");
  (1258, 4, "");
  (1187, 5, "");
  (1200, 6, "r");
  (1201, 0, "a");
  ...
  (2498, 0, " ");
  (2500, 85, "");
  (2466, 0, "\t// Sadly we can't use internal_state here because it generates a cyclic dependancy.\n");
  (2585, 68, "");
  (2551, 0, "\tlet completed = game_state == null ? false : !!game_state.complete\n");
  (2652, 0, "c");
  (2653, 0, "o");
  (2654, 0, "m");
  (2655, 0, "p");
  ...
  (4041, 0, " ");
  (3950, 0, "// ");
  (4081, 0, "$: game_completed = current_stage == null ? false : (current_stage.type === 'complete')\n");
  (4081, 0, "// ");
  (4206, 17, "&");
  (4207, 0, "&");
  (4172, 0, "// ");
  ...
  (9003, 0, "\n\t\t\t\t\t");
  (9004, 5, "");
  (9004, 0, "\t\t\t\t\t\t<button on:click={upd('_magister', 'true')}>Assume the mantle of Magister Ludi</button>\n\t\t\t\t\t\tWhen present, only the Master of the Games has access to the game controls.\n");
  (9098, 6, "\t\t\t\t\t");
  (9004, 6, "\t\t\t\t\t");
  (9177, 1, "");
  (9097, 5, "\t\t\t\t\t\t");
  ...
  (9201, 0, "\n\t\t\t\t\t\t\t");
  (9209, 1, "");
  (9100, 101, "\t\t\t\t\t\t<div> You are the master of the games. No other players can access this room's controls.");
  (9111, 1, "");
  (9193, 0, "<");
  (9194, 0, "/");
  (9195, 0, "d");
  ...
  (9209, 0, "v");
  (9210, 0, ">");
  (9200, 83, "\t\t\t\t\t\t<div>You will lose this status if you close this browser window. </div>");
  (9270, 1, "");
  (9272, 3, "p");
  (9207, 3, "p");
  (9195, 3, "p");
  ...
  (7585, 3, "p");
  (7398, 3, "p");
  (7521, 44, "\t\t\t\t\t\t<p>You are the master of the games. You have exclusive control over playing, pausing and configuring this game.</p>\n\t\t\t\t\t\t<p>Do not close this browser window or you will be dethroned.</p>\n");
  (7643, 6, "\t\t\t\t\t");
  (7515, 12, "\t\t\t\t\t");
  (7641, 3, "");
  (7520, 3, "");
  ...
  (6909, 0, ">");
  (6350, 61, "");
  (6884, 0, "\t\t<h4>Room: <em>{room}</em> <a href=\"../..\">(leave)</a></h4>\n");
  (6884, 2, "\t\t\t");
  (6306, 92, "");
  (6305, 1, "");
  (6588, 76, "");
  ...
  (1358, 66, "");
  (1428, 66, "");
  (1358, 0, "\t\tconst svgContent = topicIcons[topic as keyof typeof topicIcons]\n");
  (1494, 0, "\n\t\t");
  (1556, 0, "i");
  (1495, 2, "");
  (1554, 1, "");
  ...
  (850, 0, "\n");
  (851, 0, "\n");
  (852, 0, "\t<audio bind:this={round_audio} src=\"/lo-metal-tone.mp3\" preload=\"auto\" autoplay><track kind=\"captions\"></audio>\n\t<audio bind:this={complete_audio} src=\"/hi-metal-tone.mp3\" preload=\"auto\"><track kind=\"captions\"></audio>\n");
  (852, 1, "");
  (852, 18, "");
  (863, 0, " ");
  (864, 0, "=");
